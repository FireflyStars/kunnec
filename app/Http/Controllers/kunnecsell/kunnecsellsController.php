...
use App\state;
use auth;
class kunnecsellsController extends Controller
{
    /**
    ...
    {
        //
        $adds = kunnecsell::where('user_id',auth::id())->orderby('id','desc')->paginate(12);
        return view('home.sell.products',compact('adds'));
    }
    ...
    public function create()
    {
        ...
        return view('home.sell.create',compact('category','states'));
    }
    ...
    public function show($id)
    {
        ...
        return view('home.sell.product',compact('sell'));
    }
