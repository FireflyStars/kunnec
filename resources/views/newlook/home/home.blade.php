      ...
      <div class="col-lg-8 pr-lg-2">
              ...
              <div class="card-header bg-light">
                <div class="media align-items-center">
                      <div class="avatar avatar-m">
                          <img class="rounded-circle" src="images/users/profiles/sabrina" alt="" />
                      </div>
              ...
              <div class="card-body p-0">
                    <form>
                          ...
                          <div class="d-flex align-items-center border-y px-3 mt-1">
                            <label class="text-nowrap mb-0 mr-2" for="hash-tags"><span class="fas fa-plus mr-1 fs--2"></span><span class="font-weight-regular">Add hashtag</span></label>
                            <input class="form-control border-0 fs--1" id="hash-tags" type="text" placeholder="Help the right person to see" />
                          </div>
                          <div class="row no-gutters justify-content-between mt-3 px-3 pb-3">
                            <div class="col">
                              <button class="btn btn-light btn-sm bg-light rounded-capsule shadow-none d-inline-flex align-items-center fs--1 ml-1 mb-0" type="button"><img class="cursor-pointer" src="images/illustrations/image.svg" width="17" alt="" /><span class="ml-2 d-none d-md-inline-block">Image</span></button>
                              <button class="btn btn-light btn-sm bg-light rounded-capsule shadow-none d-inline-flex align-items-center fs--1 ml-1" type="button"><img class="cursor-pointer" src="images/illustrations/calendar.svg" width="17" alt="" /><span class="ml-2 d-none d-md-inline-block">Event</span></button>
                              <button class="btn btn-light btn-sm bg-light rounded-capsule shadow-none d-inline-flex align-items-center fs--1 ml-1" type="button"><img class="cursor-pointer" src="images/illustrations/video-camera.png" width="17" alt="" /><span class="ml-2 d-none d-md-inline-block text-nowrap">Video</span></button>
                            </div>
                            <div class="col-auto">
                              <div class="dropdown d-inline-block mr-1">
                                <button class="btn btn-sm dropdown-toggle px-1" id="dropdownMenuButton" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span style="color: #009900" class="fas fa-globe-americas"></span></button>
                              ...
                              <button class="btn btn-success btn-sm px-4 px-sm-5" type="submit">Share</button>
                            </div>
                          </div>
                    </form>
              </div>
        ...
        <div class="card mb-3">
                  ...
                  <div class="col">
                        <div class="media">
                              <div class="avatar avatar-2xl status-online">
                                   <img class="rounded-circle" src="images/users/profiles/4.jpg" alt="" />
                              </div>
                              <div class="media-body align-self-center ml-2">
                                 <p class="mb-1 line-height-1">
                                      <a class="font-weight-semi-bold" href="../pages/profile.html"> 
                                         Rowan Atkinson
                                      </a> 
              ...
              <div class="card-body overflow-hidden">
                ...
                <div class="row mx-n1">
                      <div class="col-6 p-1">
                          <a href="images/users/gallery/20.jpg" data-fancybox="gallery" data-caption="Image caption">
                              <img class="rounded w-100" src="images/users/gallery/22.jpg" alt="" />
                          </a>
                      </div>
                      <div class="col-6 p-1">
                          <a href="images/users/gallery/21.jpg" data-fancybox="gallery" data-caption="Image caption">
                              <img class="rounded w-100" src="images/users/gallery/21.jpg" alt="" />
                          </a>
                      </div>
                      <div class="col-4 p-1">
                          <a href="images/users/gallery/4.jpg" data-fancybox="gallery" data-caption="Image caption">
                              <img class="rounded w-100" src="images/users/gallery/4.jpg" alt="" />
                          </a>
                      </div>
                      <div class="col-4 p-1">
                          <a href="images/users/gallery/5.jpg" data-fancybox="gallery" data-caption="Image caption">
                              <img class="rounded w-100" src="images/users/gallery/5.jpg" alt="" />
                          </a>
                      </div>
                      <div class="col-4 p-1">
                          <a href="images/users/gallery/3.jpg" data-fancybox="gallery" data-caption="Image caption">
                              <img class="rounded w-100" src="images/users/gallery/3.jpg" alt="" />
                          </a>
                      </div>
                </div>
              </div>
              <div class="card-footer bg-light pt-0">
                ...
                <div class="row no-gutters font-weight-semi-bold text-center py-2 fs--1">
                      <div class="col-auto">
                          <a class="rounded d-flex align-items-center mr-3" href="#!">
                              <img src="images/illustrations/like-active.png" width="20" alt="" />
                              <span class="ml-1">Like</span>
                          </a>
                      </div>
                      <div class="col-auto">
                          <a class="rounded d-flex align-items-center mr-3" href="#!">
                              <img src="images/illustrations/comment-active.png" width="20" alt="" />
                              <span class="ml-1">Comment</span>
                          </a>
                      </div>
                      <div class="col-auto d-flex align-items-center">
                          <a class="rounded text-700 d-flex align-items-center" href="#!">
                              <img src="images/illustrations/share-inactive.png" width="20" alt="" />
                ...
                <div class="media mt-3">
                      ...
                      <div class="media-body ml-2 fs--1">
                            <p class="mb-1 bg-200 rounded-soft p-2">
                                  <a class="font-weight-semi-bold" href="../pages/profile.html">Rowan Atkinson</a> 
                ...
                <div class="media mt-3">
                      <div class="avatar avatar-xl">
                        <img class="rounded-circle" src="images/users/profiles/3.jpg" alt="" />
                      </div>
                      <div class="media-body ml-2 fs--1">
                            <p class="mb-1 bg-200 rounded-soft p-2">
                              <a class="font-weight-semi-bold" href="../pages/profile.html">Jessalyn Gilsig</a> 
        ...
        <div class="card mb-3">
                      ...
                      <div class="col">
                        <div class="media">
                          <div class="avatar avatar-2xl">
                            <img class="rounded-circle" src="images/users/profiles/15.jpg" alt="" />

                          </div>
                          <div class="media-body align-self-center ml-2">
                            <p class="mb-1 line-height-1"><a class="font-weight-semi-bold" href="../pages/profile.html">Margot Robbie</a></p>
              ...
              <div class="card-footer bg-light pt-0">
                ...
                <div class="row no-gutters font-weight-semi-bold text-center py-2 fs--1">
                      <div class="col-auto">
                          <a class="rounded d-flex align-items-center mr-3 text-700" href="#!">
                              <img src="images/illustrations/like-inactive.png" width="20" alt="" />
                              <span class="ml-1">Like</span>
                          </a>
                      </div>
                      <div class="col-auto">
                ...
                <div class="media mt-3">
                      ...
                      <div class="media-body ml-2 fs--1">
                         <p class="mb-1 bg-200 rounded-soft p-2">
                           <a class="font-weight-semi-bold" href="../pages/profile.html">Jessalyn Gilsig</a> Jessalyn Sarah Gilsig is a Canadian-American actress known for her roles in television series, e.g., as Lauren Davis in Boston Public, Gina Russo in Nip/Tuck, Terri Schuester in Glee, and as Siggy Haraldson on the History Channel series Vikings. 🏆
                        </p>
                        <div class="px-2">
        ...
        <div class="card mb-3">
              <img class="card-img-top" src="images/users/gallery/13.jpg" alt="" />
              <div class="card-body overflow-hidden">
                      ...
                      <div class="col">
                        <div class="media">
                              ...
                              <div class="media-body fs--1">
                                <h5 class="fs-0">
                                    <a href="../pages/event-detail.html">FREE New Year's Eve Midnight Harbor Fireworks</a>
                                </h5>
              ...
              <div class="card-footer bg-light pt-0">
                <div class="row no-gutters font-weight-semi-bold text-center py-2 fs--1">
                      ...
                      <div class="col-auto">
                          <a class="rounded d-flex align-items-center mr-3 text-700" href="#!">
                              <img src="images/illustrations/comment-inactive.png" width="20" alt="" />
                              <span class="ml-1">Comment</span>
                          </a>
                      </div>
                      <div class="col-auto d-flex align-items-center">
        ...
        <div class="card mb-3">
              <div class="card-header bg-light">
                <div class="row justify-content-between">
                      <div class="col">
                        <div class="media">
                              <div class="avatar avatar-2xl">
                                <img class="rounded-circle" src="images/users/profiles/10.jpg" alt="" />
                              </div>
                              <div class="media-body align-self-center ml-2">
                                <p class="mb-1 line-height-1">
                                      <a class="font-weight-semi-bold" href="../pages/profile.html">Leonardo DiCaprio</a> shared a <a href="#!">photo</a>
                                  </p>
                                <p class="mb-0 fs--1">
              ...
              <div class="card-body overflow-hidden">
                  <a href="images/users/gallery/11.jpg" data-fancybox="" data-caption="Image caption">
                      <img class="rounded w-100" src="images/users/gallery/11.jpg" alt="" />
                  </a>
              </div>
              <div class="card-footer bg-light pt-0">
                <div class="row no-gutters font-weight-semi-bold text-center py-2 fs--1">
        ...
        <div class="card mb-3">
              <div class="card-header bg-light">
                <div class="row justify-content-between">
                  <div class="col">
                    <div class="media">
                      <div class="avatar avatar-2xl">
                        <img class="rounded-circle" src="images/users/profiles/8.jpg" alt="" />
              ...
              <div class="card-footer bg-light pt-0">
                <div class="row no-gutters font-weight-semi-bold text-center py-2 fs--1">
                  <div class="col-auto"><a class="rounded d-flex align-items-center mr-3 text-700" href="#!"><img src="images/illustrations/like-inactive.png" width="20" alt="" /><span class="ml-1">Like</span></a></div>
                  <div class="col-auto"><a class="rounded d-flex align-items-center mr-3 text-700" href="#!"><img src="images/illustrations/comment-inactive.png" width="20" alt="" /><span class="ml-1">Comment</span></a></div>
                  <div class="col-auto d-flex align-items-center"><a class="rounded text-700 d-flex align-items-center" href="#!"><img src="images/illustrations/share-inactive.png" width="20" alt="" /><span class="ml-1">Share</span></a></div>
                </div>
                <form class="d-flex align-items-center border-top border-200 pt-3">
                  <div class="avatar avatar-xl">
                    <img class="rounded-circle" src="images/users/profiles/sabrina" alt="" />
              ...
              <div class="card-header bg-light">
                    <div class="row justify-content-between">
                          <div class="col">
                                <div class="media">
                                      <div class="avatar avatar-2xl status-online">
                                        <img class="rounded-circle" src="images/users/profiles/17.jpg" alt="" />
                                      </div>
                                      <div class="media-body align-self-center ml-2">
                                          <p class="mb-1 line-height-1">
      ...
      <div class="col-lg-4 pl-lg-2">
        <div class="card">
            <div class="card-header bg-light d-flex justify-content-between align-items-center">
                <h5 class="mb-0">You May Know ...</h5><a class="fs--1" href="#!">See all</a>
            </div>
            <div class="card-body">
              <div class="media">
                    <div class="avatar avatar-3xl">
                      <img class="rounded-circle" src="images/users/profiles/5.jpg" alt="" />
                    </div>
                    <div class="media-body ml-2">
                      <h6 class="mb-0">
                      ...
                      <button class="btn btn-light btn-sm py-0 mt-1 border" type="button">
                            <span style="color: #009900" class="fas fa-user-plus" data-fa-transform="shrink-5 left-2"></span><span class="fs--1">Follow</span>
                      </button>
        ...
        <div class="card mt-4 mb-3 mb-lg-0">
                ...
                <div class="card-body fs--1">
                  <div class="media btn-reveal-trigger">
                        ...
                        <div class="media-body position-relative pl-3">
                          <h6 class="fs-0 mb-0"><a href="../pages/event-detail.html">Newmarket Nights</a></h6>
                  ...
                  <div class="media btn-reveal-trigger">
                        ...
                        <div class="media-body position-relative pl-3">
                          <h6 class="fs-0 mb-0"><a href="../pages/event-detail.html">31st Night Celebration</a></h6>
                  ...
                  <div class="media btn-reveal-trigger">
                        ...
                        <div class="media-body position-relative pl-3">
                          <h6 class="fs-0 mb-0"><a href="../pages/event-detail.html">Folk Festival</a></h6>
                ...
                <div class="card-footer bg-light py-0 border-top">
                    <a class="btn btn-link btn-block" href="../pages/events.html" style="color: #009900;">All Events
