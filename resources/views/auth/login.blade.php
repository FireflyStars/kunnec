...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header" style="background:#1672c4 !important; color: white;">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="fname" type="text" class="form-control{{ $errors->has('fname') ? ' is-invalid' : '' }}" name="fname" value="{{ old('fname') }}" placeholder="Full Name" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12 row">
                                <div class="col-md-4">
                                    <select name="birth_day" id="date" class="form-control">
                                        <option>Date</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
